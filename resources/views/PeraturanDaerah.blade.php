...
<!-- Judul Halaman -->
@section('judul_halaman', 'Peraturan Daerah')
...
@section('content')
    ...
    <section class="wrapper bg-light wrapper-border">
      <div class="container py-14 py-md-16">
        <h2 class="display-5 mb-3 text-center mb-5">Dokumen Hukum <font style="color:#FC0101">@yield('judul_halaman')</font></h2>
        <div class="row justify-content-md-center">
            ...
            <div class="col col-lg-3">
                <div class="form-select-wrapper">
                <select class="form-select" aria-label="Default select example">
                    <option selected>Peraturan Daerah</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                </select>
        ...
        <div class="row mt-5">
            <div class="col-4">
                ...
                <div class="accordion accordion-wrapper" id="accordionExample">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="card-body mb-1">
                        <ul class="unordered-list bullet-primary">
                            <li><a href="#">Peraturan Daerah (311)</a></li>
                        </ul>                        
                        </div>
                        <!--/.card-body -->
                    </div>
            ...
            {{-- Result Doc --}}
            <div class="col-8">
                Ditemukan <font color="red">311</font> dokumen hukum peraturan daerah
                {{-- Dokumen --}}
